...
public class SchemaTypeXmlGenerator {
    ...
    private void initNSMap() {
        ...
        System.out.println(MessageFormat.format("namespace map contains {0} entries", nsMap.size()));
    }
    ...
    public String generateXml(QName elName, boolean isPrettyPrint) {
        ...
        if (elName != null && schemaColl != null) {
            ...
            if (el != null) {
                ...
                System.out.println("got null for element generated for qname: {}" + elName);
            }
            ...
            try {
                ...
                System.out.println("dom4j Document to xml creation error"+ e);
            }
    ...
    public void generateXmlForType(QName typeName, Element rootEl) {
        if (typeName != null && rootEl != null) {
            ...
            if (schemaType != null) {
                ...
                System.out.println("Could not locate any type with name: {}"+typeName);
            }
        } else {
            System.out.println("Either type name or root element is null, cannot generate xml");
        }
    }
    ...
    private Element handleElement(XmlSchemaElement schEl) {
        ...
        if (refEl != null) {
            System.out.println("Handling schema element reference {}" + refEl.getName());
        ...
        if (sch != null) {
            System.out.println("---> Pushed schema with tns\\: {} into stack" + sch.getTargetNamespace());
